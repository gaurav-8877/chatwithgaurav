            ...
            <div className="w-full md:w-1/2 p-6 sm:p-8 flex items-center justify-center md:border-r border-slate-600/30">
              <div className="w-full max-w-sm">
                ...
                <div className="text-center mb-8">
                  <MessageCircleIcon className="w-10 sm:w-12 h-10 sm:h-12 mx-auto text-slate-400 mb-3 sm:mb-4" />
                  <h2 className="text-xl sm:text-2xl font-bold text-slate-200 mb-2">Welcome Back</h2>
                  <p className="text-sm sm:text-base text-slate-400">Login to access to your account</p>
                </div>
                ...
                <div className="mt-6 text-center">
                  <Link to="/signup" className="auth-link text-xs sm:text-sm">
